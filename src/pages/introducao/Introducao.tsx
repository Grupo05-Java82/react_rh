      ...
      <div className="max-w-3xl mx-auto p-6">
        ...
        <ul className="space-y-4">
          ...
          duration-200">
            ...
            <div>
              <h3 className="text-lg font-semibold  ">Cadastrar novos colaboradores</h3>
              <p className="text-sm  ">Adicione novos membros à equipe com facilidade.</p>
            </div>
          </li>
          ...
          duration-200">
            ...
            <div>
              <h3 className="text-lg font-semibold ">Consultar quem já trabalha na empresa</h3>
              <p className="text-sm ">Visualize a lista atual de colaboradores ativos.</p>
            </div>
          </li>
          <li className="
          flex 
          ...
          duration-200">
            ...
            <div>
              <h3 className="text-lg font-semibold">Atualizar dados quando algo muda</h3>
              <p className="text-sm">Mantenha as informações sempre atualizadas.</p>
            </div>
          </li>
          ...
          duration-200">
            <div className="text-2xl">🗑️</div>
            <div>
              <h3 className="text-lg font-semibold">Remover registros, se necessário</h3>
              <p className="text-sm">Exclua colaboradores que não fazem mais parte da equipe.</p>
            </div>
          </li>
        </ul>
      </div>
